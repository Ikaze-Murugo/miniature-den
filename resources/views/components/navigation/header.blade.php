...
<nav x-data="navigation()" class="bg-white/95 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-50 shadow-sm">
    <!-- Mobile Navigation -->
    <div class="xl:hidden">
        <!-- Mobile Header -->
        <div class="flex justify-between items-center px-4 py-3">
            ...
            <div class="flex items-center space-x-3">
                <button @click="toggleMobileMenu()" 
                        class="p-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500">
