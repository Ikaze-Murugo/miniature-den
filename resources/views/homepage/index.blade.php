    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="container-anthropic">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-xl font-semibold mb-4">Murugo</h3>
                    <p class="text-gray-400 mb-4">
                        Rwanda's leading property rental platform connecting landlords with quality tenants.
                    </p>
                ...
                <div>
                    <h4 class="font-semibold mb-4">For Renters</h4>
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="#" class="hover:text-white transition-colors">Browse Properties</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">Search by Location</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">Property Alerts</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="#" class="hover:text-white transition-colors">Property Management</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">Analytics</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">Tenant Screening</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; {{ date('Y') }} Murugo. All rights reserved. Made with ❤️ in Rwanda.</p>
            </div>
        </div>
    </footer>
